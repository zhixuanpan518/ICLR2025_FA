...
net.fc = nn.Sequential(
    ...
    nn.Linear(500, 10)         # 最后的全连接层，将特征数从512缩小到目标类别数10
)

# matrix = torch.zeros((500, 10))
# for i in range(10):
#     matrix[50*i:50*i+50, i] = 1

# with torch.no_grad():
#     net.fc[2].weight = nn.Parameter(matrix.t())
#     net.fc[2].bias = nn.Parameter(torch.zeros(10))
...
checkpoint_path = 'checkpoint/twolayer_10_20.pth'
...
for i in range(1):
    ...
    def test(epoch):
        ...
        with open("twolayer_attack_result/10_test_benign_accuracy.txt", 'a') as file:
            file.write(str(100. * benign_correct / total)+"\n")
        with open("twolayer_attack_result/10_test_adv_accuracy.txt", 'a') as file:
            file.write(str(100. * adv_correct / total)+"\n")
        with open("twolayer_attack_result/10_test_benign_loss.txt", 'a') as file:
            file.write(str(benign_loss)+"\n")
        with open("twolayer_attack_result/10_test_adv_loss.txt", 'a') as file:
    ...
    def train(epoch):
        ...
        with open("twolayer_attack_result/10_train_benign_accuracy.txt", 'a') as file:
            file.write(str(100. * benign_correct / total)+"\n")
        with open("twolayer_attack_result/10_train_adv_accuracy.txt", 'a') as file:
            file.write(str(100. * adv_correct / total)+"\n")
        with open("twolayer_attack_result/10_train_benign_loss.txt", 'a') as file:
            file.write(str(benign_loss)+"\n")
        with open("twolayer_attack_result/10_train_adv_loss.txt", 'a') as file:
            file.write(str(adv_loss)+"\n")
