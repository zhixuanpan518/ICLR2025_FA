...
# checkpoint_path = 'checkpoint/pretrained_10_100.pth'
...
for i in range(1):
    ...
    def test(epoch):
        ...
        # with open("pre_attack_result/test_benign_accuracy.txt", 'a') as file:
        #     file.write(str(100. * benign_correct / total)+"\n")
        # with open("pre_attack_result/test_adv_accuracy.txt", 'a') as file:
        #     file.write(str(100. * adv_correct / total)+"\n")
        # with open("pre_attack_result/test_benign_loss.txt", 'a') as file:
        #     file.write(str(benign_loss)+"\n")
        # with open("pre_attack_result/test_adv_loss.txt", 'a') as file:
    ...
    def train(epoch):
        ...
        # with open("pre_attack_result/train_benign_accuracy.txt", 'a') as file:
        #     file.write(str(100. * benign_correct / total)+"\n")
        # with open("pre_attack_result/train_adv_accuracy.txt", 'a') as file:
        #     file.write(str(100. * adv_correct / total)+"\n")
        # with open("pre_attack_result/train_benign_loss.txt", 'a') as file:
        #     file.write(str(benign_loss)+"\n")
        # with open("pre_attack_result/train_adv_loss.txt", 'a') as file:
        #     file.write(str(adv_loss)+"\n")
