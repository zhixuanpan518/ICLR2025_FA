...
#     nn.init.normal_(net.fc[0].weight, mean=0.0, std=0.000001)
#     nn.init.normal_(net.fc[0].bias, mean=0.0, std=0.000001)
...
for epoch in range(20):
    ...
    if epoch%10 == 9:
        ...
        torch.save(checkpoint, f'checkpoint/test_{epoch+1}.pth')
