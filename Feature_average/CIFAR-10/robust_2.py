...
for i in range(20):
    ...
    def test(epoch):
        ...
        with open("attack_result/2_test_benign_accuracy.txt", 'a') as file:
            file.write(str(100. * benign_correct / total)+"\n")
        with open("attack_result/2_test_adv_accuracy.txt", 'a') as file:
            file.write(str(100. * adv_correct / total)+"\n")
        with open("attack_result/2_test_benign_loss.txt", 'a') as file:
            file.write(str(benign_loss)+"\n")
        with open("attack_result/2_test_adv_loss.txt", 'a') as file:
    ...
    def train(epoch):
        ...
        with open("attack_result/2_train_benign_accuracy.txt", 'a') as file:
            file.write(str(100. * benign_correct / total)+"\n")
        with open("attack_result/2_train_adv_accuracy.txt", 'a') as file:
            file.write(str(100. * adv_correct / total)+"\n")
        with open("attack_result/2_train_benign_loss.txt", 'a') as file:
            file.write(str(benign_loss)+"\n")
        with open("attack_result/2_train_adv_loss.txt", 'a') as file:
            file.write(str(adv_loss)+"\n")
