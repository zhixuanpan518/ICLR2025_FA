...
train_dataset = MNIST(root='./data', train=True, download=True, transform=transform,target_transform=fine_to_coarse)
test_dataset = MNIST(root='./data', train=False, download=True, transform=transform, target_transform=fine_to_coarse)
...
checkpoint = torch.load('./checkpoint/MNIST2_10.pth')
...
for i in range(10):
    ...
    def test(epoch):
        ...
        with open("attack_result_inf/MNIST_2_k=5.txt", 'a') as file:
